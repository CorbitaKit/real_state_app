...
<template>
    <section id="contact" class="tw-py-16 tw-bg-lime-600 tw-text-white app-style">
        ...
        <a href="mailto:contact@realestateapp.com" class="tw-mt-6 tw-inline-block tw-text-black tw-bg-white tw-text-green-600 tw-py-3 tw-px-8 tw-rounded-full tw-text-lg hover:tw-bg-gray-200 tw-transition">Get in Touch</a>
        </div>
    </section>
</template>