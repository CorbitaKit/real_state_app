            ...
            <ul class="metismenu" id="sidebarNav">
                ...
                <li :class="{active: isActive('/properties') || isActive('/properties/create')}" v-if="user.role.name != 'Client'">
                    ...
                    <ul aria-expanded="false">
                        <li> <a href='/properties'><i class="nav-icon fa fa-list"></i> Property List</a> </li>
                ...
                <li v-if="user.role.name != 'Client'" >
                    ...
                    <ul aria-expanded="false">
                        <li> <a href='/users'><i class="nav-icon fa fa-user-clock"></i> Staff List</a> </li>
                        <li> <a href='/users/create'><i class="nav-icon fa fa-user-plus"></i>Add Staff</a> </li>
                ...
                <li v-if="user.role.name === 'Admin' || user.role.name === 'Staff'" :class="{active: isActive('/clients') || isActive('/users/create-client')}">
                    ...
                    <ul aria-expanded="false">
                        <li> <a href='/clients'><i class="nav-icon fa fa-user-tie"></i> Client List</a> </li>
                        <li> <a href='/users/create-client'><i class="nav-icon fa fa-user-plus"></i>Add client</a> </li>
                ...
                <li :class="{active: isActive('/payments/get-by-user') || isActive('/payments/create')}" v-if="user.role.name === 'Client'">
                    ...
                    <ul aria-expanded="false">
                        <li> <a href='/payments/get-by-user'><i class="nav-icon fa fa-receipt"></i> Payment List</a> </li>
                        <li> <a href='/payments/create'><i class="nav-icon fa fa-receipt"></i> Make A Payment</a> </li>
